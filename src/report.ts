...
export function projectReport(result: AuditResult, locale: ReportLocale = "en-US"): ReportProjection {
  const labels = labelsFor(locale);
...
function renderFinding(result: AuditResult, locale: ReportLocale): string {
