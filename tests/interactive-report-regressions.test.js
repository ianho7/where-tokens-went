...
function reportSynthesisFor(audit, overrides = {}) {
  ...
  return {
    ...
    findings: [
      ...
      {
        title: '工具结果放大与模型集中度共同塑造用量峰值',
        analysis: '工具结果在多轮中反复暴露，配合主模型的长上下文输入形成了主要的用量集中现象。',
        evidenceRefs: ['summary:modelCallCount', 'ranking:models:gpt-4.1'],
        support: 'moderate',
        uncertainty: '工具规模估算未考虑不同工具的具体压缩机制。',
      },
    ],
